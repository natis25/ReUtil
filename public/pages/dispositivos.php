...
<body>
    ...
    <div class="container">
        ...
        <button class="btn-login" onclick="abrirModal(null)">Agregar Nuevo Dispositivo</button>
                ...
                <tbody>
                    <?php foreach ($dispositivos as $dispositivo): ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-warning me-2" onclick='abrirModal(<?= json_encode($dispositivo) ?>)'>
                                    Editar
                                </button>
                                <button class="btn btn-sm btn-danger" onclick="confirmarEliminar(<?= $dispositivo['id_dispositivo'] ?>)">
                                    Eliminar
                                </button>
                            </td>
                        </tr>
                                ...
                                <select class="form-select" id="tipo_dispositivo_id" name="tipo_dispositivo_id" required>
                                    ...
                                    <?php foreach ($tipos as $tipo): ?>
                                        <option value="<?= $tipo['id_tipo'] ?>">
                                            <?= htmlspecialchars($tipo['nombre_tipo'] ?? $tipo['tipo'] ?? 'Desconocido') ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
